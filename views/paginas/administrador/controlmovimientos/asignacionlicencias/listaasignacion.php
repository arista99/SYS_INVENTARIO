...
<div class="container-xl px-4 mt-4">
    <!-- Account page navigation-->
     <nav class="nav nav-borders">
        <a class="nav-link active ms-0" href="ListaGeneralAsignacionLicencia">Lista de Asignacion de Licencia</a>
        <a class="nav-link"  href="ControlAsignacionLicencia">Crear Asignación de Licencia</a>
    </nav>
    ...
    <div class="row mb-3">
        <div class="col-md-4">
            <input type="text" name="asignacion" id="asignacion" class="form-control" placeholder="Nombre Equipo">
        </div>
        <div class="col-md-2">
    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div class="card mb-4">
                <div class="card-header">Lista de Asignación de Licencia</div>
                <div class="card-body">
                    <!-- Table -->
                    <table class="table table-bordered" id="tablaDatosAsignacionLicencia" width="100%" cellspacing="0">
                        <thead>
                            <tr>
