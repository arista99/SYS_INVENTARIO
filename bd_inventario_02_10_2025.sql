...
-- Volcando datos para la tabla sys_inventario_transber.tbl_fabricantes: ~7 rows (aproximadamente)
...
-- Volcando datos para la tabla sys_inventario_transber.tbl_modelos: ~13 rows (aproximadamente)
